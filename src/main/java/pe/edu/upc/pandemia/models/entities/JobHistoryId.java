...
public class JobHistoryId implements Serializable {
	...
	/**
	 * JobHistoryId jobHistoryId1 = new JobHistoryId(1, new Date("2021", "01",
	 * "10")); JobHistoryId jobHistoryId2 = new JobHistoryId(2, new Date("2021",
	 * "03", "10")); if (jobHistoryId1 == employee) if(this == obj) ->
	 * representativo
	 */
